...
Estudiante de Ingeniería en Desarrollo de Software en el ITESO (Promedio: 9.14/10, Graduación esperada: Dic 2026)[cite: 1]. Apasionado por el desarrollo web y móvil full-stack, creando arquitecturas robustas en la nube e interfaces funcionales[cite: 1].
...
<p align="left">
  ...
  <a href="https://nestjs.com/" target="_blank"><img src="https://raw.githubusercontent.com/devicons/devicon/master/icons/nestjs/nestjs-original.svg" width="40" height="40" alt="NestJS" /></a>
...
*   **Lenguajes:** TypeScript, JavaScript, Java, Python, C, Dart, HTML5, CSS3, SQL[cite: 1].
*   **Frameworks & Librerías:** Next.js 16, React 19, NestJS, React Native, Expo, Spring Boot, Flutter, Node.js, Express, Tailwind CSS, Fabric.js, Django, Angular[cite: 1].
*   **Cloud & Infraestructura:** AWS (S3, Lambda, EC2, SES), Azure, Docker, Render, CI/CD pipelines, Serverless Architecture[cite: 1].
*   **Bases de Datos & ORM:** PostgreSQL, MongoDB, PostGIS, Drizzle ORM, Prisma, Redis[cite: 1].
*   **Herramientas & Testing:** Git, GitHub, pnpm, Playwright, Postman, WebSockets (Socket.IO), GraphQL, REST APIs, Figma[cite: 1].
...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/IsaacNoriega">P-P-Custom</a></h3>
      <p>Plataforma e-commerce con editor gráfico interactivo (Fabric.js) y sistema de gestión de pedidos end-to-end[cite: 1].</p>
      <p>
    ...
    <td width="50%" valign="top">
      <h3><a href="https://github.com/IsaacNoriega">School Sync Suite</a></h3>
      <p>Plataforma multi-tenant con arquitectura monorepo pnpm, RBAC granular y seguimiento de asistencia en tiempo real mediante WebSockets[cite: 1].</p>
      <p>
  ...
  <tr>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/IsaacNoriega">NextDate</a></h3>
      <p>Interfaz móvil multiplataforma con integración de APIs de Gemini AI para itinerarios dinámicos y cálculos de proximidad con PostGIS[cite: 1].</p>
      <p>
    ...
    <td width="50%" valign="top">
      <h3><a href="https://github.com/IsaacNoriega">Skoolia</a></h3>
      <p>Marketplace digital y motor de búsqueda para instituciones educativas con soporte para inscripción de usuarios y seguimiento de leads[cite: 1].</p>
      <p>
        <img src="https://img.shields.io/badge/Next.js-000000?style=flat-square&logo=next.js&logoColor=white" />
        <img src="https://img.shields.io/badge/NestJS-E0234E?style=flat-square&logo=nestjs&logoColor=white" />
  ...
  <tr>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/IsaacNoriega">Macacos Condos Admin</a></h3>
      <p>Aplicación SaaS multi-tenant para la gestión administrativa de propiedades en condominios y canales de comunicación[cite: 1].</p>
      <p>
    ...
    <td width="50%" valign="top">
      <h3><a href="https://github.com/IsaacNoriega">ReUseITESO</a></h3>
      <p>Marketplace digital gamificado enfocado en el intercambio sustentable de artículos dentro de la comunidad universitaria[cite: 1].</p>
      <p>
  ...
  <tr>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/IsaacNoriega">CVCloud</a></h3>
      <p>Servicio serverless para la generación y distribución de PDFs utilizando microservicios en la nube[cite: 1].</p>
      <p>
    ...
    <td width="50%" valign="top">
      <h3><a href="https://github.com/IsaacNoriega">Gizmo Notes</a></h3>
      <p>Aplicación móvil gamificada de seguimiento de hábitos diarios enfocada en la productividad personal y finalización de metas[cite: 1].</p>
      <p>
        <img src="https://img.shields.io/badge/Flutter-02569B?style=flat-square&logo=flutter&logoColor=white" />
        <img src="https://img.shields.io/badge/Dart-0175C2?style=flat-square&logo=dart&logoColor=white" />
        <img src="https://img.shields.io/badge/Mobile-333333?style=flat-square&logo=android&logoColor=white" />
      </p>
    </td>
  </tr>
</table>
